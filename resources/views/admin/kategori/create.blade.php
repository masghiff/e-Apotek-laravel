              ...
              <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{route('admin.kategori.create')}}" class="row g-3 needs-validation" novalidate>
                      @csrf
                      <div class="col-12">
                      ...
                      <div class="col-12">
                        <button class="btn btn-primary w-100" type="submit">Tambah Kategori</button>
                      </div>
                    </form>
